...
const pathToPage = (pathname: string): string => {
  ...
  const match = Object.entries(PAGE_TO_PATH).find(
        ...
        return (
          <section className="min-h-screen pt-36 pb-20 px-6 bg-linear-to-b from-slate-50 to-white">
            <div className="max-w-3xl mx-auto text-center">
              <span className="text-orange-500 font-black uppercase tracking-[0.4em] text-[10px] block mb-4">
                404
              </span>
              ...
              <p className="text-slate-500 font-medium mb-10">
                The page you requested is unavailable. Use the actions below to
                continue browsing.
              </p>
