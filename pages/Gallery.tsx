...
const Gallery: React.FC<GalleryProps> = ({ onNavigate }) => {
  useSEO({
    title: "Gallery",
    description:
      "View our custom screen printing portfolio. Browse examples of t-shirts, hoodies, sweatshirts, and custom apparel we have produced for brands and events.",
    canonical: "/gallery",
    ogTitle: "Gallery - ST Custom Screen Printing",
    ogDescription:
      "Browse our custom screen printing portfolio. T-shirts, hoodies, sweatshirts, and custom apparel.",
  });
      ...
      <section className="pt-24 pb-16 px-6 sm:px-8 lg:px-12">
        <motion.div {...revealProps} className="max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold uppercase tracking-tight leading-tight mb-4">
            ...
            <span className="text-purple-500">Recent</span>{" "}
            <span className="text-slate-900">Portfolio</span>
          </h1>
          <p className="text-base text-slate-600 leading-snug font-medium max-w-2xl">
            Browse our finest screen print projects showcasing precision,
            consistency, and artisanal quality in every design.
          </p>
        </motion.div>
      </section>
            ...
            {PROJECT_IMAGES.map((src, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute top-4 right-4 ${badgeColors[idx % badgeColors.length]} text-white px-4 py-2 rounded-full text-xs font-black uppercase tracking-wider shadow-lg transform group-hover:scale-110 transition-transform duration-300`}
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-white/90 font-bold leading-relaxed [text-shadow:0_1px_8px_rgba(0,0,0,0.5)]">
                        {PROJECT_DETAILS[idx]?.subtitle ||
                          "A recent screen print run showcasing quality."}
                      </p>
                    </div>
      ...
      <section className="py-20 px-6 sm:px-8 lg:px-12 bg-linear-to-br from-slate-50 to-slate-100 border-t border-slate-200">
        <motion.div {...revealProps} className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base text-slate-600 leading-snug font-medium mb-10 max-w-2xl mx-auto">
            Whether you need a small custom run or large-scale production, our
            team delivers the same precision and quality you see in our gallery.
          </p>
