...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ onNavigate }) => {
  useSEO({
    ...
    description:
      "ST Custom Screen Printing privacy policy. Learn how we collect, use, and protect your personal information when you visit our website or place an order.",
    canonical: "/privacy",
    ogTitle: "Privacy Policy",
    ogDescription:
      "Learn how ST Custom Screen Printing collects, uses, and protects your personal information.",
  });
  return (
    <div className="min-h-screen bg-slate-50 animate-in pt-24 md:pt-28 lg:pt-32">
      ...
      <section className="relative z-10 px-6 sm:px-8 lg:px-12 max-w-4xl mx-auto mb-12">
        ...
        <p className="text-slate-500 font-medium leading-relaxed text-base mb-2">
          Your privacy is important to us. Please review how we collect, use,
      ...
      <section className="relative z-10 px-6 sm:px-8 lg:px-12 max-w-4xl mx-auto pb-20">
        <div className="bg-white border border-slate-200 rounded-3xl p-8 md:p-12 shadow-[0_8px_40px_rgba(15,23,42,0.06)]">
          <div className="text-base leading-relaxed text-slate-600 space-y-0">
            <p className="pb-6">
              This Privacy Policy governs the manner in which ST Custom Screen
              Printing collects, uses, maintains and discloses information
              collected from users (each, a "User") of the ST Custom Screen
              Printing website ("Site"). This privacy policy applies to the Site
              and all products and services offered by ST Custom Screen
              Printing.
            </p>
            ...
            <div className="border-b border-slate-100 pb-6">
              ...
              <p>
                ...
                visit our Site, place an order, respond to a survey and in
                ...
                number, and payment information for the purpose of processing
                your order. We will collect personal identification information
                from Users only if they voluntarily submit such information to
                us. Users can always refuse to supply personal identification
                information, except that it may prevent them from engaging in
                certain Site related activities, such as placing an order.
              </p>
            </div>
            ...
            <div className="border-b border-slate-100 pb-6">
              ...
              <p>
                ...
                web browser saves cookies for record-keeping purposes and
                sometimes to track information about their Site usage. Users may
            ...
            <div className="border-b border-slate-100 pb-6">
              ...
              <p>
                ST Custom Screen Printing collects and uses Users' personal
              ...
              <ul className="list-disc pl-5 space-y-2 mt-2">
                ...
                <li>
                  ...
                  outside parties except to the extent necessary to provide
                  service.
                </li>
                <li>
                  To administer content, promotions, surveys or other Site
                  features — To send Users information about topics we think
            ...
            <div className="border-b border-slate-100 pb-6">
              <h2 className="text-base font-black uppercase tracking-tight text-slate-900 mb-2">
                Periodic Emails &amp; Communications
              </h2>
              <p>
                The email address Users provide for order processing will be
                used to send them information and updates pertaining to their
                order. It will also be used to respond to their inquiries and/or
                other requests or questions. Every User who decides to opt-in to
                our mailing list will receive emails that may include company
                news, updates, related product or service information, etc. If
                at any time the User would like to unsubscribe from receiving
                future emails, we allow Users to unsubscribe at the bottom of
                each mailer or User may contact us via our Site.
              </p>
            </div>
            ...
            <div className="border-b border-slate-100 pb-6">
              ...
              <p>
                ...
                purposes outlined above. We may use third party service
                ...
                third parties for those limited purposes provided that you are
                giving us your permission when you sign up or order with us.
              </p>
            </div>

            <div className="border-b border-slate-100 pb-6">
              <h2 className="text-base font-black uppercase tracking-tight text-slate-900 mb-2">
                Consent to Phone Messages
              </h2>
              <p>
                By providing your phone number, you consent to receive text
                messages from ST Custom Screen Printing regarding your inquiry,
                updates, and other relevant information. Message frequency may
                vary. Message and data rates may apply. For assistance, reply
                HELP or contact info@stcsprinting.com. To stop receiving
                messages, reply STOP. No further messages will be sent.
              </p>
            </div>
            ...
            <div className="border-b border-slate-100 pb-6">
              ...
              <p>
                ST Custom Screen Printing has the discretion to update this
            ...
            <div className="pb-6">
              ...
              <p>
                ...
                do not use our Site. If you have any questions about this
                Privacy Policy, the practices of this site, or your dealings
                with this site, please contact us at info@stcsprinting.com or
                (732) 347-0101.
              </p>
            </div>
          </div>
