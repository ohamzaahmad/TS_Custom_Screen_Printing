    ...
    <div className="min-h-screen pb-32 bg-white animate-in">
      ...
      <div className="bg-brand-dark py-48 md:py-64 mb-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-10 text-center relative z-10">
          <span className="text-orange-500 font-black uppercase tracking-[0.5em] text-[11px] mb-10 block">
            The Curated Essentials
          </span>
          <h1 className="text-7xl md:text-[10rem] font-black text-white mb-10 uppercase tracking-tighter leading-none select-none">
            THE <span className="text-gradient-orange italic">STUDIO.</span>
          </h1>
          <p className="text-white/30 max-w-2xl mx-auto text-xl md:text-2xl font-medium leading-relaxed">
            Every blank in our collection has passed industrial wash-tests and
            color-depth requirements. Only the best for your brand.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-48 space-y-10">
            ...
            <p className="text-slate-400 font-black uppercase tracking-[0.4em] text-[11px]">
              Synchronizing Blank Inventory...
            </p>
          </div>
        ) : (
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="pt-12 px-6 text-center md:text-left">
                  <h3 className="text-4xl font-black text-slate-900 uppercase tracking-tighter mb-6 group-hover:text-purple-600 transition-colors">
                    {product.name}
                  </h3>
                  <p className="text-slate-500 text-lg mb-10 leading-relaxed font-medium line-clamp-2">
                    {product.description}
                  </p>
                  ...
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                    {product.colors.map((color) => (
                      <span
                        key={color}
                        className="w-6 h-6 rounded-full border border-slate-200 shadow-sm transition-transform hover:scale-125"
                        title={color}
                        style={{
                          backgroundColor:
                    ...
                    <span className="text-[11px] font-black text-slate-300 ml-6 uppercase tracking-[0.2em]">
                      {product.colors.length} Stock Bases
                    </span>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-48">
        <div className="bg-brand-dark rounded-[5rem] p-20 md:p-32 flex flex-col lg:flex-row items-center justify-between gap-16 border border-white/5 relative overflow-hidden group">
          ...
          <div className="max-w-2xl relative z-10 text-center lg:text-left">
            <h3 className="text-5xl md:text-6xl font-black uppercase tracking-tighter mb-8 text-white leading-[0.9]">
              Custom Sourcing Request?
            </h3>
            <p className="text-white/30 font-medium text-xl md:text-2xl leading-relaxed">
              We maintain global accounts with Comfort Colors, Bella+Canvas, and
              AS Colour. If your desired silhouette isn't in our core
              collection, we can secure it.
            </p>
          </div>
          <button
