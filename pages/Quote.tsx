...
const Quote: React.FC<QuoteProps> = () => {
  useSEO({
    ...
    description:
      "Request a custom screen printing quote from ST Custom Screen Printing. Get pricing for t-shirts, hoodies, sweatshirts, and custom apparel orders.",
    canonical: "/quote",
    ogTitle: "Request a Quote - ST Custom Screen Printing",
    ogDescription:
      "Get pricing for custom screen printing orders. T-shirts, hoodies, sweatshirts, and more.",
  });
      ...
      <section className="relative z-10 max-w-6xl mx-auto">
        <div className="mb-10 text-center">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto font-medium">
            Submit your print requirements through our hosted form. Our team
            reviews every request and replies with pricing and timeline.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
            ...
            <p className="text-sm text-slate-500">
              Share garment type, quantity, print locations, and deadline.
            </p>
          </div>
          <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 mb-2">
            ...
            <p className="text-sm text-slate-500">
              Attach your files directly in the hosted form workflow.
            </p>
          </div>
          <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 mb-2">
            ...
            <p className="text-sm text-slate-500">
              Expect a response with recommendations and pricing guidance.
            </p>
          </div>
        </div>
        ...
        <div
          id="cognito-embed"
          className="bg-white/95 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 min-h-120"
        >
