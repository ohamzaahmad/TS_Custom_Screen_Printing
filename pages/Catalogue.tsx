...
const Catalogue: React.FC<CatalogueProps> = ({ onNavigate }) => {
  useSEO({
    title: "Catalogue",
    description:
      "Browse the ST Custom Screen Printing apparel catalogue. T-shirts, hoodies, sweatshirts, trousers, bags, and specialty garments available for custom screen printing.",
    canonical: "/catalogue",
    ogTitle: "Catalogue - ST Custom Screen Printing",
    ogDescription:
      "Browse our apparel catalogue. T-shirts, hoodies, sweatshirts, and more for custom screen printing.",
  });
    ...
    <div className="bg-[#fcfcfc] min-h-screen overflow-hidden">
      ...
      <section className="py-16 px-6 sm:px-8 lg:px-12 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
              <div className="order-2 lg:order-1">
                <div className="relative">
                  {/* Step Number */}
                  <div className="text-5xl md:text-6xl font-black text-orange-100 mb-4 leading-none">
                    01
                  </div>
                  ...
                  <div className="space-y-4">
                    <motion.a
                      ...
                      whileHover={
                        reduceMotion ? undefined : { scale: 1.03, y: -4 }
                      }
          ...
          >
            <svg
              className="w-8 h-8 text-orange-500 mx-auto"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
              ...
              <div>
                <div className="relative">
                  {/* Step Number */}
                  <div className="text-5xl md:text-6xl font-black text-purple-100 mb-4 leading-none">
                    02
                  </div>
                  <h2 className="text-2xl md:text-3xl font-bold text-slate-900 uppercase tracking-tight mb-4">
                    Note Your Picks
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="relative">
                  {/* Step Number */}
                  <div className="text-5xl md:text-6xl font-black text-slate-900 mb-4 leading-none">
                    03
                  </div>
                  <h2 className="text-2xl md:text-3xl font-bold text-slate-900 uppercase tracking-tight mb-4">
                    Complete Your Order
                  ...
                  <div className="space-y-4">
                    <button
                      ...
                      className="w-full bg-linear-to-r from-slate-900 to-purple-700 text-white px-6 py-3 rounded-xl font-bold uppercase tracking-[0.2em] text-sm shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all active:scale-95 flex items-center justify-center gap-3"
                    >
                      <svg
                        className="w-6 h-6"
                        fill="none"
                    ...
                    <button
                      ...
                      className="w-full bg-linear-to-r from-orange-500 to-purple-500 text-white px-6 py-3 rounded-xl font-bold uppercase tracking-[0.2em] text-sm hover:opacity-95 transition-all active:scale-95 flex items-center justify-center gap-3"
                    >
                      <svg
                        className="w-6 h-6"
                        fill="none"
                ...
                <div className="relative h-56 md:h-72 rounded-xl overflow-hidden border border-slate-900 shadow-md bg-linear-to-br from-slate-900 to-slate-800 flex items-center justify-center">
                  <div className="text-center space-y-4 px-6">
                    ...
                    <p className="text-slate-300 text-xs font-medium">
                      Get your custom apparel printed
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="hidden md:grid md:grid-cols-3 gap-8 relative">
              {/* Connecting Line */}
              <div
                className="absolute top-20 left-0 right-0 h-1 bg-linear-to-r from-orange-500 via-purple-500 to-slate-900"
                aria-hidden="true"
              ></div>
      ...
      <section className="py-20 px-6 sm:px-8 lg:px-12 bg-blue-50 border-t border-blue-200">
        ...
        >
          <div className="bg-white border-2 border-blue-300 rounded-3rem p-8 md:p-12 flex items-start gap-6">
            <svg
              className="w-10 h-10 shrink-0 text-blue-600"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div className="grow">
              ...
              <p className="text-slate-600 leading-relaxed font-medium mb-6">
                Our team is ready to guide you through the entire process. Call,
                email, or chat with us anytime.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="tel:+17323470101"
                  className="bg-slate-900 text-white px-6 py-3 rounded-full font-black uppercase tracking-[0.2em] text-sm hover:bg-slate-800 transition-all inline-flex items-center gap-2"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M3 5a2 2 0 012-2h3.28a1 1 0 00.948.684l1.498 4.493a1 1 0 00.502.756l2.048 1.029a2.42 2.42 0 010 4.33l-2.048 1.029a1 1 0 00-.502.756l-1.498 4.493a1 1 0 00-.948.684H5a2 2 0 01-2-2V5z"
                    />
                  </svg>
                  Call us
                </a>
                <a
                  ...
                  className="bg-blue-600 text-white px-6 py-3 rounded-full font-black uppercase tracking-[0.2em] text-sm hover:bg-blue-700 transition-all inline-flex items-center gap-2"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
