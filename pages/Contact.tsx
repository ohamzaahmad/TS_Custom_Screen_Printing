...
const Contact: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white animate-in pt-24 md:pt-28 lg:pt-32">
      <div className="absolute inset-0 z-0 bg-linear-to-b from-orange-50 via-white to-white" aria-hidden="true"></div>
      ...
      <section className="relative z-10 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto mb-16">
        <motion.div
          ...
          transition={reduceMotion ? undefined : { duration: 0.7, ease: EASE_OUT }}
        >
          ...
          <p className="text-slate-500 font-medium leading-relaxed max-w-2xl text-lg">
            Ready to bring your vision to life? Reach out to our team for a consultation, quote, or any questions about our services.
          </p>
        </motion.div>
      </section>
      ...
      <section className="relative z-10 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto mb-20">
        <motion.div {...revealProps} className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 text-white">
              ...
              <ul className="space-y-5">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/50 mb-1">Phone</p>
                    <a href="tel:+17323470101" className="font-bold hover:text-orange-400 transition-colors">
                      (732) 347-0101
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/50 mb-1">Email</p>
                    <a href="mailto:info@stcsprinting.com" className="font-bold hover:text-orange-400 transition-colors">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/50 mb-1">Hours</p>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/50 mb-1">Location</p>
                    <p className="font-bold leading-relaxed">1 Bradshaw Drive<br />Manahawkin, NJ 08050</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 shadow-sm">
              ...
              <div id="cognito-contact-embed" className="min-h-[450px]">
      ...
      <section className="relative z-10 px-6 sm:px-8 lg:px-12 py-16 bg-slate-50 border-t border-slate-100">
        <motion.div {...revealProps} className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-slate-500 font-medium mb-8 max-w-xl mx-auto">
            Our team is available during business hours to discuss your project requirements and provide immediate assistance.
          </p>
          <a
