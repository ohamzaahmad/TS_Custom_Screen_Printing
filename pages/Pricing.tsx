...
const Pricing: React.FC = () => {
  useSEO({
    title: "Pricing",
    description:
      "ST Custom Screen Printing pricing for custom screen printing orders. Transparent per-shirt pricing for t-shirts, hoodies, sweatshirts, and more.",
    canonical: "/pricing",
    ogTitle: "Pricing - ST Custom Screen Printing",
    ogDescription:
      "Transparent per-shirt pricing for custom screen printing orders. T-shirts, hoodies, sweatshirts, and more.",
  });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h1 className="fluid-h1 font-black text-slate-900 leading-none tracking-tighter uppercase mb-2">
            SCREEN PRINT{" "}
            <span className="text-gradient-orange">PRICING 2026</span>
          </h1>
          <h2 className="text-xl font-black text-slate-400 uppercase tracking-[0.3em]">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#E9F3F8]">
                <th className="py-5 px-6 text-sm font-black uppercase tracking-widest text-slate-700">
                  Quantity
                </th>
                <th className="py-5 px-6 text-sm font-black uppercase tracking-widest text-slate-700">
                  1 Color
          ...
          <div className="space-y-6">
            ...
            <div className="border-[3px] border-slate-900 p-10 md:p-14 min-h-[280px] flex flex-col justify-center">
              ...
              <p className="text-xl font-bold text-slate-600 leading-relaxed">
                ...
                <span className="text-slate-900 font-black underline decoration-orange-500">
                  100%
                </span>{" "}
                is required to start your order. No exceptions.
              </p>
            </div>
          </div>
